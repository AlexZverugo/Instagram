package by.zverugo.samsolutions.instagram.dao.rating.impl;
...
public class RatingDaoImpl implements RatingDao {
    ...
    public Rating getRatingBySenderAndPostId(long sender, long postId) {
        String posthql = "FROM  by.zverugo.samsolutions.instagram.entity.Rating R WHERE R.sender.id = :sender " +
